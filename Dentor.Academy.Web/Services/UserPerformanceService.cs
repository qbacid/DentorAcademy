...
public class UserPerformanceService
{
    ...
    public UserPerformanceService(QuizDbContext context, ILogger<UserPerformanceService> logger)
    {
        _context = context;
        _logger = logger;
    }
    ...
    {
        var attemptsWithCategory = await _context.QuizAttempts
            .Include(qa => qa.Quiz)
    ...
    public async Task<List<QuizAttemptSummaryDto>> GetUserQuizAttemptsAsync(string userId)
    {
        ...
        {
            var correctCount = await _context.UserResponses
