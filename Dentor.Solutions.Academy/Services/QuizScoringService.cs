...
public class QuizScoringService : IQuizScoringService
{
    ...
    public QuizScoringService(ApplicationDbContext dbcContext)
    {
    ...
    {
        var question = await _dbcContext.Questions
        ...
        List<int> selectedAnswerOptionIds)
    {
        ...
        _dbcContext.UserResponses.Add(userResponse);
        ...
        foreach (var answerId in selectedAnswerOptionIds)
        {
            ...
            _dbcContext.UserResponseAnswers.Add(userResponseAnswer);
        }
    ...
    {
        var attempt = await _dbcContext.QuizAttempts
            .Include(qa => qa.Quiz)
    ...
    {
        var question = await _dbcContext.Questions.FindAsync(questionId);
